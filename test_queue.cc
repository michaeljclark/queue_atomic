...
struct test_queue
{
    ...
    void test_queue_constants_v4()
    {
        const size_t qsize = 1024;
        typedef queue_atomic_v4<void*> qtype;
        qtype q(qsize);
        
        printf("queue_atomic_v4::is_lock_free  = %u\n", q.version_counter.is_lock_free());
        printf("queue_atomic_v4::atomic_bits   = %u\n", qtype::atomic_bits);
        printf("queue_atomic_v4::offset_bits   = %u\n", qtype::offset_bits);
        printf("queue_atomic_v4::version_bits  = %u\n", qtype::version_bits);
        printf("queue_atomic_v4::front_shift   = %u\n", qtype::front_shift);
        printf("queue_atomic_v4::back_shift    = %u\n", qtype::back_shift);
        printf("queue_atomic_v4::version_shift = %u\n", qtype::version_shift);
        printf("queue_atomic_v4::size_max      = 0x%016llx (%llu)\n", (u64)qtype::size_max, (u64)qtype::size_max);
        printf("queue_atomic_v4::offset_limit  = 0x%016llx (%llu)\n", (u64)qtype::offset_limit, (u64)qtype::offset_limit);
        printf("queue_atomic_v4::version_limit = 0x%016llx (%llu)\n", (u64)qtype::version_limit, (u64)qtype::version_limit);
        printf("queue_atomic_v4::offset_mask   = 0x%016llx\n", (u64)qtype::offset_mask);
        printf("queue_atomic_v4::version_mask  = 0x%016llx\n", (u64)qtype::version_mask);
        printf("queue_atomic_v4::front_pack    = 0x%016llx\n", (u64)qtype::front_pack);
        printf("queue_atomic_v4::back_pack     = 0x%016llx\n", (u64)qtype::back_pack);
        printf("queue_atomic_v4::version_pack  = 0x%016llx\n", (u64)qtype::version_pack);
    ...
    {
        test_push_pop_threads<int,queue_std_vec_mutex_v1<int>>("queue_std_vec_mutex_v1", 8, 10, 1024);
    }

    void test_push_pop_threads_v2()
    {
        test_push_pop_threads<int,queue_std_queue_mutex_v2<int>>("queue_std_queue_mutex_v2", 8, 10, 1024);
    }
    ...
    void test_push_pop_threads_v4()
    {
        test_push_pop_threads<int,queue_atomic_v4<int>>("queue_atomic_v4", 8, 10, 1024);
        test_push_pop_threads<int,queue_atomic_v4<int>>("queue_atomic_v4", 8, 10, 65536);
        test_push_pop_threads<int,queue_atomic_v4<int>>("queue_atomic_v4", 8, 64, 65536);
        test_push_pop_threads<int,queue_atomic_v4<int>>("queue_atomic_v4", 8, 16, 262144);
    }
};
...
int main(int argc, const char * argv[])
{
    ...
    tq.test_push_pop_v3();
    tq.test_queue_constants_v4();
    tq.test_empty_invariants_v4();
    tq.test_push_pop_v4();
    tq.test_push_pop_threads_v4();
